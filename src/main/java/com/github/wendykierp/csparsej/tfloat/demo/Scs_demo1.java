...
import com.github.wendykierp.csparsej.tfloat.Scs_entry;
...
import com.github.wendykierp.csparsej.tfloat.Scs_print;
...
public class Scs_demo1 {
    public static void main(String[] args) {
        ...
        int i, m;
        if (args.length == 0) {
            throw new IllegalArgumentException("Usage: java com.github.wendykierp.csparsej.tfloat.semo.Scs_demo1 fileName");
        }
